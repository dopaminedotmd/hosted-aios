...
3. <REPO_ROOT>\users\user3\bots\

UPPGIFT: Installera mina personliga bottar för hosted-aiOS.

STEG:
1. Läs varje bot-mapp under users/user3/bots/
...
4. Läs users/user3/memory/ — ladda in mina preferenser och tidigare kontext
5. Läs users/user3/skills/ — ladda in mina personliga skills
...
- Spara dina slutsatser till users/user3/memory/install-log.md
```
