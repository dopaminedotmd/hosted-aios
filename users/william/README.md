...
3. <REPO_ROOT>\users\william\bots\

UPPGIFT: Installera mina personliga bottar för hosted-aiOS.

STEG:
1. Läs varje bot-mapp under users/william/bots/
...
4. Läs users/william/memory/ — ladda in mina preferenser och tidigare kontext
5. Läs users/william/skills/ — ladda in mina personliga skills
...
- Spara dina slutsatser till users/william/memory/install-log.md
```
